...
public class InteractionController {
    ...
    // 🌟 Comment Edit (AJAX) - Upgraded with Session Security
    ...
    public String editComment(
        ...
        boolean success = interactionService.editComment(commentId, currentUser.getId(), newContent);
        return "{\"success\": " + success + "}";
    }

    // 🌟 Comment Delete (AJAX) - Upgraded with Session Security
    ...
    public String deleteComment(
        ...
        boolean success = interactionService.deleteComment(commentId, currentUser.getId());
        return "{\"success\": " + success + "}";
    }
}