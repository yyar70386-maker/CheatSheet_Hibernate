...
<nav
	...
	<div class="container">
		<a class="navbar-brand fw-bold fs-4 d-flex align-items-center"
			...
			class="bi bi-code-square me-2 text-primary"></i> <span
			class="text-dark">Cheat</span><span class="text-primary">Sheet</span>
		</a>
				...
				<c:choose>
					...
					<c:when test="${empty sessionScope.currentUser}">
						<li class="nav-item"><a
							...
							style="border-radius: 6px; padding: 6px 16px;"> <i
								class="bi bi-box-arrow-in-right me-1"></i> Sign In
						</a></li>
						<li class="nav-item"><a
							class="btn btn-primary text-white d-flex align-items-center"
							href="${pageContext.request.contextPath}/register"
							style="border-radius: 6px; padding: 6px 16px;"> <i
								class="bi bi-person-plus me-1"></i> Register
						</a></li>
					</c:when>
						...
						<li class="nav-item dropdown me-lg-2"><a
							...
							<ul class="dropdown-menu dropdown-menu-end notification-menu"
								...
								<li
									...
									href="${pageContext.request.contextPath}/notifications">View
										all</a>
								</li>
								<li><hr class="dropdown-divider"></li>
								<li id="notificationEmpty" class="px-3 py-2 text-muted small">No
						...
						<li class="nav-item dropdown"><a
							...
							data-bs-toggle="dropdown" aria-expanded="false"> <c:choose>
									<c:when test="${not empty sessionScope.currentUser.avatarPath}">
										<img
											src="${pageContext.request.contextPath}/uploads/${sessionScope.currentUser.avatarPath}"
											class="rounded-circle me-2 nav-avatar" width="32" height="32">
									</c:when>
									<c:otherwise>
										<i class="bi bi-person-circle me-2 text-secondary"
											style="font-size: 1.4rem;"></i>
									</c:otherwise>
								</c:choose> <span class="fw-medium">${sessionScope.currentUser.fullName}</span>
						</a>
							...
							<ul class="dropdown-menu dropdown-menu-end"
								...
								<li><a class="dropdown-item"
									href="${pageContext.request.contextPath}/profile"> <i
										class="bi bi-person me-2 text-primary"></i> My Profile
								</a></li>
								<li><hr class="dropdown-divider"></li>
