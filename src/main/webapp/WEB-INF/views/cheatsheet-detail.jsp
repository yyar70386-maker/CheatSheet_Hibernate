...
<body>
    ...
    <div class="detail-container">
        ...
        <div>
            ...
            <span class="author-text">by ${sheet.author != null ? sheet.author.username : 'Unknown'} 
                <span class="text-muted ms-3" style="font-size: 16px;"><i class="bi bi-eye"></i> ${sheet.viewCount} Views</span>
            </span>
        </div>
    ...
    <script>
        ...
        function postMainCommentJS() {
            ...
            .then(data => {
                ...
                if (msg) msg.remove(); // Remove "no comments" message if exists
