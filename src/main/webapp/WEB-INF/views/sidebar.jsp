...
<c:if test="${sessionScope.currentUser.role == 1}">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark admin-sidebar"
         style="box-shadow: 2px 0 5px rgba(0, 0, 0, 0.05); height: 100vh; position: sticky; top: 0;">
        ...
        <ul class="nav nav-pills flex-column mb-auto" style="overflow-y: auto; flex-grow: 1; padding-right: 4px;">
            ...
            <li>
                <%-- 🌟 [UPDATED] Tag Management လမ်းကြောင်းအား Admin Layout ထဲသို့ ကွက်တိပြန်ညွှန်းထားခြင်း --%>
                <a href="${pageContext.request.contextPath}/admin/tags"
                   class="nav-link text-white ${param.activePage == 'tags' ? 'active' : ''}">
