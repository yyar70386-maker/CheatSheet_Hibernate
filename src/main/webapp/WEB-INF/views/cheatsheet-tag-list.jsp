...
<body class="bg-light">
    ...
    <div class="container my-5">
        ...
        <%-- Header Section ပြောင်းလဲမှု --%>
        <div class="page-header-section">
            <h1 class="display-5 fw-bold text-dark">${totalCount} Cheat Sheets tagged with #${tagName}</h1>
            <a href="javascript:history.back()" class="btn btn-sm btn-outline-secondary mt-2">
                        ...
                        <div class="col-md-6 col-lg-4 grid-item">
                            <div class="cheatsheet-card">
                                <div>
                                    ...
                                    <%-- 🌟 ဤနေရာတွင် မိတ်ဆွေတောင်းဆိုထားသော Updated At ရက်စွဲအား ဖြည့်စွက်ပေးထားပါသည် --%>
                                    <div class="card-meta-item">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 my-3">
                                        <c:forEach items="${sheet.tags}" var="tag">
                                            <a href="${pageContext.request.contextPath}/cheatsheet/tag/${tag.id}" class="tag-badge-link ${tag.id == param.tagId ? 'bg-primary text-white' : ''}">#${tag.name}</a>
                                        </c:forEach>
                                    </div>
                                </div>
